...
PYBIND11_MODULE(_cpp, m) {
    ...
    py::class_<RobotData<float>>(m, "RobotDataFloat")
        ...
        .def_readonly("root_lin_vel_b", &RobotData<float>::root_lin_vel_b)
        ...
        .def_readonly("joint_vel", &RobotData<float>::dq)
    ...
    py::class_<RobotData<double>>(m, "RobotData")
        ...
        .def_readonly("root_lin_vel_b", &RobotData<double>::root_lin_vel_b)
        ...
        .def_readonly("joint_vel", &RobotData<double>::dq)
